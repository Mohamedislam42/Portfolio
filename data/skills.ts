...
export const skillCategories: SkillCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Multi-Agent AI Systems (LangChain)', level: 'Core', projectRef: 'multi-agent-research-assistant' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Multi-Threading & Concurrency', level: 'Core' },
      { name: 'Socket Programming (TCP/IP)', level: 'Core' },
  ...
  },
  {
    ...
    featured: false,
    items: [
      { name: 'Unity & NavMesh Pathfinding', level: 'Core' },
      { name: 'Blender Skeletal Rigging & IK', level: 'Proficient' },
      { name: 'JavaFX & FXML GUI', level: 'Core' },
